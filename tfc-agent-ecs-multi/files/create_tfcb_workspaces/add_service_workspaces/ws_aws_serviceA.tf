module "ws_aws_serviceA" {
    #source  = "app.terraform.io/presto-projects/tfe-workspace/mod"
    source = "../modules/workspace-agent"
    agent_pool_id     = data.terraform_remote_state.presto_projects_ws_aws_iam.outputs.serviceA_agentpool_id
    organization = "${var.organization}"
    queue_all_runs = false
    auto_apply = true
    workspacename = "ws_aws_serviceA"
